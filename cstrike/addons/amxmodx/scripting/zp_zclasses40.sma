/*================================================================================
	...
	------------------------------------------
	-*- [Biohazard] Default Zombie Classes -*-
	------------------------------------------
...
{
	register_plugin("[Biohazard] Default Zombie Classes", "XecT", "ByOreo")
